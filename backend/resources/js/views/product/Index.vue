...
export default {
    ...
    methods: {
        ...
        filterProducts() {
            let new_prices = $('#priceRange').val()

            this.new_prices = new_prices.replace(/[\s+]|[$]/g, '').split('-');
            ...
            this.axios.get(`http://127.0.0.1:8000/api/products/filters`)
                .then(res => {
                    ...
                    if ($("#price-range").length) {
                        $("#price-range").slider({
                            range: true,
                            min: +this.filterList.new_price.min,
                            max: +this.filterList.new_price.max,
                            values: [+this.filterList.new_price.min, +this.filterList.new_price.max],
                                ...
                                <div class="sidebar-holder">
                                    ...
                                    <div class="single-sidebar-box mt-30 wow fadeInUp animated ">
                                        ...
                                        <div class="checkbox-item">
                                            <form v-for="category in filterList.categories">
                                                <div class="form-group"><input :value="category.id" v-model="categories" type="checkbox" :id="category.id"> <label
                                                                ...
                                                                <div class="row justify-content-between align-items-center">
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="popup-right-content">
                                                                            ...
                                                                            <div class="price">
                                                                                <h2> ${{ popupProduct.new_price }} USD
                                                                                    <del> ${{ popupProduct.old_price }} USD</del>
                                                                                </h2>
                                                                                <h6> In stuck</h6>
                                                                            </div>
                                                                            <div class="color-varient">
                                                                                <template v-for="groupProduct in popupProduct.group_products">
                                                                                    <a @click.prevent="getProduct(groupProduct.id)" v-for="color in groupProduct.colorsGroup" href="#0" :style="`background: #${ color.title };` " class="color-name"><span>{{ color.title }}</span> </a>
                                                                                </template>
                                                                            </div>
